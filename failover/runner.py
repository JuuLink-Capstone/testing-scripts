...
#   times based on a yaml file. Most of this was generated by AI, although 
#   some tweaks had to be made to get it running correctly, and some 
#   features were added manually.
#
# Usage: runner.py <jobs.yaml> [time]
#
...
def main() -> None:
    if len(sys.argv) < 2:
        print("Usage: runner.py <jobs.yaml> [time]")
        sys.exit(1)
    elif len(sys.argv) == 2:
